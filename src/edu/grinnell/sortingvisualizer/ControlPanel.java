...
public class ControlPanel extends JPanel {
     ...
     */
    private static List<SortEvent<Integer>> generateEvents(String sort, ArrayList<Integer> arr) {
        switch (sort) {
        case "Selection":
    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                nts.addAll(notes.getNotes());
                final List<SortEvent<Integer>> events = generateEvents((String)sorts.getSelectedItem(), nts);
